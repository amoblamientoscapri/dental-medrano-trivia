...
export function ResultScreen({
  ...
  if (won) {
    return (
      <div className="text-center w-full max-w-lg mx-auto animate-bounce-in">
        ...
        {/* Trophy */}
        <div className="w-16 h-16 mx-auto mb-2 rounded-full bg-orange-brand/10 flex items-center justify-center glow-orange">
          <svg
            className="w-8 h-8 text-orange-brand"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <h2 className="text-3xl font-extrabold text-gray-brand mb-1 animate-sparkle">
          ¡¡GANASTE!!
        </h2>
        <p className="text-orange-brand font-bold text-base mb-2">
          ¡Felicitaciones!
        </p>

        <div className="bg-green-50 border-2 border-green-300 rounded-2xl p-3 mb-4 animate-slide-up">
          <svg className="w-8 h-8 text-green-500 mx-auto mb-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <button
          onClick={onPlayAgain}
          className="bg-orange-brand hover:bg-orange-dark text-white font-bold px-8 py-3 rounded-xl text-lg transition-all duration-200 cursor-pointer active:scale-[0.97] animate-scale-pop"
  ...
  return (
    <div className="text-center w-full max-w-lg mx-auto animate-bounce-in">
      {/* Sad face icon */}
      <div className="w-16 h-16 mx-auto mb-2 rounded-full bg-red-50 flex items-center justify-center">
        <svg
